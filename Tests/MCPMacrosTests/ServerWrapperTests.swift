...
// 테스트 비활성화 - 실제 출력이 변경됨
final class ServerWrapperTestsDisabled: MacroBaseTestCase {
    
    func disabled_testAutoGeneratedWrapperMethod() {
        assertMacro {
            """
    ...
    func disabled_testServerWithExtension() {
        assertMacro {
            """
            // ServerWrapper.swift
